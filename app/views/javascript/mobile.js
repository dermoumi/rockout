...
// Date:   Tue Dec  6 17:38:42 GMT 2011;
//==============================================================================

//==============================================================================
// THIS CODE IS BARELY MODIFIED FROM MOBILEESP !!!
//==============================================================================
...
/**
 *  Detects whether the site is actually running on a mobile or not
 */
var rkt_isMobile = (function() {
...
// Stores whether the device can probably support Rich CSS, but JavaScript 
// support is not assumed. (e.g., newer BlackBerry, Windows Mobile)
var isTierRichCss = false; 
// Stores whether it is another mobile device, which cannot be assumed to 
// support CSS or JS (eg, older BlackBerry, RAZR)
...
var mobile = "mobile"; //Some mobile browsers put 'mobile' in the useragent str.
var mobi = "mobi"; //Some mobile browsers put 'mobi' in their useragent strings.
...
// These devices will have 'Android' and NOT 'mobile' in their user agent.
